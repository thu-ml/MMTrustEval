(
    ...
    do
        CUDA_VISIBLE_DEVICES=0 nohup python -u test_run_zw.py --task ${task_ids[0]} --model_id ${model_id} --output_dir /data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-${shot}-debug >> /data/zhangyichi/Trustworthy-MLLM/MMTrustEval/privacy_scripts/logs/${task_ids[0]}-${shot}-${model_id}.log 2>&1 &
    ...
    # for model_id in "${model_ids[@]}";
    # do
    #     CUDA_VISIBLE_DEVICES=4 nohup python -u test_run_zw.py --task ${task_ids[0]} --model_id ${model_id} --output_dir /data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-${shot}-debug >> /data/zhangyichi/Trustworthy-MLLM/MMTrustEval/privacy_scripts/logs/${task_ids[0]}-${shot}-${model_id}.log 2>&1 &
    #     CUDA_VISIBLE_DEVICES=7 nohup python -u test_run_zw.py --task ${task_ids[1]} --model_id ${model_id} --output_dir /data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-${shot}-debug >> /data/zhangyichi/Trustworthy-MLLM/MMTrustEval/privacy_scripts/logs/${task_ids[1]}-${shot}-${model_id}.log 2>&1 &
    #     wait
    #     # CUDA_VISIBLE_DEVICES=3 nohup python -u test_run_zw.py --task ${task_ids[2]} --model_id ${model_id} --output_dir /data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-${shot}-debug >> /data/zhangyichi/Trustworthy-MLLM/MMTrustEval/privacy_scripts/logs/${task_ids[2]}-${shot}-${model_id}.log 2>&1 &
    #     # CUDA_VISIBLE_DEVICES=4 nohup python -u test_run_zw.py --task ${task_ids[3]} --model_id ${model_id} --output_dir /data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-${shot}-debug >> /data/zhangyichi/Trustworthy-MLLM/MMTrustEval/privacy_scripts/logs/${task_ids[3]}-${shot}-${model_id}.log 2>&1 &
    #     # CUDA_VISIBLE_DEVICES=7 nohup python -u test_run_zw.py --task ${task_ids[4]} --model_id ${model_id} --output_dir /data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-${shot}-debug >> /data/zhangyichi/Trustworthy-MLLM/MMTrustEval/privacy_scripts/logs/${task_ids[4]}-${shot}-${model_id}.log 2>&1 &
    ...
    # #     # CUDA_VISIBLE_DEVICES=3 nohup python -u test_run_zw.py --task ${task_ids[0]} --model_id ${model_id} --output_dir /data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-${shot}-debug >> /data/zhangyichi/Trustworthy-MLLM/MMTrustEval/privacy_scripts/logs/${task_ids[0]}-${shot}-${model_id}.log 2>&1 &
    # #     # CUDA_VISIBLE_DEVICES=4 nohup python -u test_run_zw.py --task ${task_ids[1]} --model_id ${model_id} --output_dir /data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-${shot}-debug >> /data/zhangyichi/Trustworthy-MLLM/MMTrustEval/privacy_scripts/logs/${task_ids[1]}-${shot}-${model_id}.log 2>&1 &
    # #     CUDA_VISIBLE_DEVICES=5 nohup python -u test_run_zw.py --task ${task_ids[2]} --model_id ${model_id} --output_dir /data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-${shot}-debug >> /data/zhangyichi/Trustworthy-MLLM/MMTrustEval/privacy_scripts/logs/${task_ids[2]}-${shot}-${model_id}.log 2>&1 &
    # #     CUDA_VISIBLE_DEVICES=6 nohup python -u test_run_zw.py --task ${task_ids[3]} --model_id ${model_id} --output_dir /data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-${shot}-debug >> /data/zhangyichi/Trustworthy-MLLM/MMTrustEval/privacy_scripts/logs/${task_ids[3]}-${shot}-${model_id}.log 2>&1 &
    # #     CUDA_VISIBLE_DEVICES=7 nohup python -u test_run_zw.py --task ${task_ids[4]} --model_id ${model_id} --output_dir /data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-${shot}-debug >> /data/zhangyichi/Trustworthy-MLLM/MMTrustEval/privacy_scripts/logs/${task_ids[4]}-${shot}-${model_id}.log 2>&1 &
    # #     wait
    # # done
)
