...
# eval_dir = '/data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-debug'
eval_dir = '/data/zhangyichi/Trustworthy-MLLM/output/privacy/pii-leakage-in-context-zeroshot-debug'
...
# TODO: reorder by tasks 
order_list = ['text', 'color', 'nature', 'noise', 'images'] 
df['task'] = pd.Categorical(df['task'], categories=order_list, ordered=True)
