...
jsonlist = glob("logs/safety/s4-typographic-jailbreaking/{}/*.json".format(args.model_id))
outfile = "results/safety/s4-typographic-jailbreaking/{}/s4-typographic-jailbreaking.json".format(args.model_id)
