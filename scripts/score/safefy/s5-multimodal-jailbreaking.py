...
jsonlist = glob("logs/safety/s5-multimodal-jailbreaking/{}/*.json".format(args.model_id))
outfile = "results/safety/s5-multimodal-jailbreaking/{}/s5-multimodal-jailbreaking.json".format(args.model_id)
