...
jsonlist = glob("logs/safety/s2-risk-identification/{}/*.json".format(args.model_id))
outfile = "results/safety/s2-risk-identification/{}/s2-risk-identification.json".format(args.model_id)
