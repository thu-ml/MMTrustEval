...
jsonlist = glob("logs/fairness/f2-stereo-agreement/{}/*.json".format(args.model_id))
outfile = "results/fairness/f2-stereo-agreement/{}/f2-stereo-agreement.json".format(args.model_id)
