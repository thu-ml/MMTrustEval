...
jsonlist = glob("logs/fairness/f7-subjective-preference/{}/*.json".format(args.model_id))
outfile = "results/fairness/f7-subjective-preference/{}/f7-subjective-preference.json".format(args.model_id)
