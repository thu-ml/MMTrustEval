...
jsonlist = glob("logs/fairness/f1-stereo-generation/{}/*.json".format(args.model_id))
outfile = "results/fairness/f1-stereo-generation/{}/f1-stereo-generation.json".format(args.model_id)
...
keyname_mapping = {
    "ChatModelEvaluator->YesOrNoEvaluator:pred_mean": "stereotype_containing_rate",
}
