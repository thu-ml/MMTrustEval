...
jsonlist = glob("logs/truthfulness/t7-visual-misleading/{}/*.json".format(args.model_id))
outfile = "results/truthfulness/t7-visual-misleading/{}/t7-visual-misleading.json".format(args.model_id)
...
keyname_mapping = {
    "ChatModelEvaluator->YesOrNoEvaluator:pred_mean": "Accuracy",
}
