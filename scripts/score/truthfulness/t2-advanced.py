...
jsonlist = glob("logs/truthfulness/t2-advanced/{}/*.json".format(args.model_id))
outfile = "results/truthfulness/t2-advanced/{}/t2-advanced-inference.json".format(args.model_id)
