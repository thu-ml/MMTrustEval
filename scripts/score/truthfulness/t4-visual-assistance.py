...
jsonlist = glob("logs/truthfulness/t4-visual-assistance/{}/*.json".format(args.model_id))
outfile = "results/truthfulness/t4-visual-assistance/{}/t4-visual-assistance.json".format(args.model_id)
