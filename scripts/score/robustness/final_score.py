...
results['final_score'] = (results['scores']["ood-artistic"] + (results['scores']["ood-sensor"] / 100.) + results['scores']["ood-text"] + results['scores']["adversarial-untarget"] + (1-results['scores']["adversarial-target"]) + results['scores']["adversarial-text"]) / 6
