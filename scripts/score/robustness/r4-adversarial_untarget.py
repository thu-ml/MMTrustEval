...
jsonlist = glob("logs/robustness/r4-adversarial-untarget/{}/*.json".format(args.model_id))
outfile = "results/robustness/r4-adversarial-untarget/{}/r4-adversarial-untarget.json".format(args.model_id)
