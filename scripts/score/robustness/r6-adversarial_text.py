...
jsonlist = glob("logs/robustness/r6-adversarial-text/{}/*.json".format(args.model_id))
outfile = "results/robustness/r6-adversarial-text/{}/r6-adversarial-text.json".format(args.model_id)
...
keyname_mapping = {
    "rule_contain_adv_eval:pred_mean": "accuracy",
}
