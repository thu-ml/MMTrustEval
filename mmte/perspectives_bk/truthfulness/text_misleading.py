...
class MisFactualEval(BaseEval):
    EVAL_DESCRIPTION = "The chat bot is presented with a question and an related image. We will ask the chat bot to answer this question."
                        
    task_list = ["g-mislead-mistext"]
    ...
    def __init__(self, task_id: str) -> None:
        ...
        self.images = []
        self.sizes = []
        query_file = "/data/zhangyichi/Trustworthy-MLLM/data/truthfulness/query_misleading/query_g_{}.json".format(task_id.split('-')[-1])
    ...
    def eval(self, test_model: BaseChat, log_response:Optional[str]=None, **kwargs):
        ...
        for statement in tqdm(self.statements):
            id += 1
            test_prompt = MisFactualEval.PROMPT_TEMPLATE.format(Statement=statement)
