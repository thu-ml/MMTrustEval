...
def is_correct(gt_label, response):
    if response is None:
        return 0
...
categories = ['base', 'augment', 'bible_p0.6', 'bible_p0', 'romantic_p0.6', 'romantic_p0', 'shake_p0.6', 'shake_p0', 'shake_w', 'tweet_p0.6', 'tweet_p0']

data_to_save={}
for category in categories:
    data_to_save[category]=[]

input_dir='/data/zhangyichi/Trustworthy-MLLM/output/robustness/description_dt_style'
for model_name in model_list:
    for category in categories:
        ...
        for score_each in score_info_list:
            ...
            correct_num+=is_correct(gt_label, response)
            total_num+=1
...
df.to_csv('/data/zhangyichi/Trustworthy-MLLM/output/robustness/score_dt_style.csv')