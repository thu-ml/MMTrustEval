...
input_dir='/data/zhangyichi/Trustworthy-MLLM/output/robustness/description_advglue_plus'
...
df.to_csv('/data/zhangyichi/Trustworthy-MLLM/output/robustness/score_advglue_plus.csv')