...
input_dir='/data/zhangyichi/Trustworthy-MLLM/output/robustness/description_advglue_original'
...
df.to_csv('/data/zhangyichi/Trustworthy-MLLM/output/robustness/score_advglue_original.csv')