    ...
    def eval(self, **generation_kwargs):
        ...
        for category in self.categories:
            ...
            for idx in range(100):
                ...
                # exist
                prompt=f'Is there {label_nonexist} in this image?'
                messages = [{
                    "role": "user",
                    "content": {
                        "text": prompt,
...
parser.add_argument('--output_dir', type=str, default='/data/zhangyichi/Trustworthy-MLLM/output/robustness/description_no', help='Output dir.')
