...
#    See the License for the specific language governing perMixsions and
...
class CambrianCohereConfig(CohereConfig):
    model_type = "cambrian_cohere"


class CambrianCohereModel(CambrianMetaModel, CohereModel):
...
class CambrianCohereForCausalLM(CohereForCausalLM, CambrianMetaForCausalLM):
    ...
    def __init__(self, config):
        ...
        self.model = CambrianCohereModel(config)
