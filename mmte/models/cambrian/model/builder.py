...
from ..model.language_model.cambrian_llama import CambrianLlamaForCausalLM
from ..model.language_model.cambrian_mistral import CambrianMistralForCausalLM
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", use_flash_attn=False, **kwargs):
    ...
    if 'cambrian' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            from ..model.language_model.cambrian_llama import CambrianConfig
            ...
            if 'mistral' in model_name.lower():
                ...
                from ..model.language_model.cambrian_phi3 import CambrianPhi3ForCausalLM
                tokenizer = AutoTokenizer.from_pretrained(model_path)
