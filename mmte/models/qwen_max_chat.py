...
class QwenMaxChat(BaseChat):
    """
    Chat class for Qwen-Max API, handling multimodal generation.
    """
    
    MODEL_CONFIG = {"qwen-vl-max": 'configs/models/qwen/qwen.yaml'}
    
    model_family = list(MODEL_CONFIG.keys())
    
    model_arch = 'qwen-max'
    
    def __init__(self, model_id: str="qwen-vl-max", **kargs):
