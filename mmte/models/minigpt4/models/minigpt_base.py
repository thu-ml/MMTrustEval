...
from mmte.models.minigpt4.models.base_model import BaseModel
from transformers import StoppingCriteria, StoppingCriteriaList

from mmte.models.minigpt4.conversation.conversation import StoppingCriteriaSub
...
class MiniGPTBase(BaseModel):
    ...
    def get_context_emb(self, prompt, img_list, device=None):
        if len(img_list)>0:
