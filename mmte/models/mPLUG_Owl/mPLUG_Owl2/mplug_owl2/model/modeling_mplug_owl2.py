...
from .modeling_owl_llama import OwlLlamaModel, OwlLlamaForCausalLM
...
class MPLUGOwl2LlamaModel(MPLUGOwl2MetaModel, OwlLlamaModel):
...
class MPLUGOwl2LlamaForCausalLM(OwlLlamaForCausalLM, MPLUGOwl2MetaForCausalLM):
    config_class = MPLUGOwl2Config

    def __init__(self, config):
        super(OwlLlamaForCausalLM, self).__init__(config)
...
from .modeling_llama2 import model_forward, causal_model_forward
OwlLlamaModel.forward = model_forward
OwlLlamaForCausalLM.forward = causal_model_forward
